<?php
if(isset($_POST['username']) && isset($_POST['user_email']) && isset($_POST['user_password']) && isset($_POST['user_number'])){
// CHECK IF FIELDS ARE NOT EMPTY && !empty(trim($_POST['user_number'])) {
...
// Escape special characters.
        ...
        $usernumber = mysqli_real_escape_string($db_connection, htmlspecialchars($_POST['user number']));
//IF EMAIL IS VALID
